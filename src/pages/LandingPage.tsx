      ...
      <header className="relative overflow-hidden bg-gradient-hero">
        <nav className="container mx-auto flex items-center justify-between px-4 py-4" aria-label="Main navigation">
          ...
          <div className="flex items-center gap-3">
            <a href="https://x.com/ummahbuild" target="_blank" rel="noopener noreferrer" aria-label="Follow Ummah Build on X" className="text-muted-foreground transition-colors hover:text-foreground">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://linkedin.com/company/ummah-build" target="_blank" rel="noopener noreferrer" aria-label="Ummah Build on LinkedIn" className="text-muted-foreground transition-colors hover:text-foreground">
