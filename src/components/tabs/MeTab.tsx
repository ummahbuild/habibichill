      ...
      <AnimatePresence mode="wait">
        ...
        {subTab === "settings" && (
          <motion.div key="settings" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
            ...
            <div className="mb-5 flex flex-col gap-2">
              <a href="https://github.com/ummahbuild/habibichill/issues/new?template=bug_report.md" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between rounded-xl border border-border bg-card p-4 transition-colors hover:bg-muted">
                <div className="text-left">
              ...
              <a href="https://github.com/ummahbuild/habibichill/issues/new?template=feature_request.md" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between rounded-xl border border-border bg-card p-4 transition-colors hover:bg-muted">
                <div className="text-left">
              ...
              <a href="https://github.com/ummahbuild/habibichill/issues" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between rounded-xl border border-border bg-card p-4 transition-colors hover:bg-muted">
                <div className="text-left">
            ...
            <div className="mb-5 flex flex-col gap-2">
              ...
              <a href="https://github.com/ummahbuild/habibichill" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between rounded-xl border border-border bg-card p-4 transition-colors hover:bg-muted">
