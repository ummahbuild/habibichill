  ...
  <footer className="border-t border-border bg-card py-8">
    <div className="container mx-auto flex flex-col items-center gap-4 px-4 text-center text-sm text-muted-foreground md:flex-row md:justify-between">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <a href="https://github.com/ummah-build/habibichill" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="transition-colors hover:text-foreground">
